  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ty_env_service,
        type    TYPE trobjtype,
        service TYPE REF TO zif_dutils_oea_env_service,
...
CLASS zcl_dutils_oea_env_srv_factory IMPLEMENTATION.
  ...
  METHOD get_service_type.
    result = SWITCH #( type
      WHEN zif_dutils_c_tadir_type=>business_object OR
           zif_dutils_c_tadir_type=>icf_node OR
           zif_dutils_c_tadir_type=>gw_project THEN type
