"! <p class="shorttext synchronized" lang="en">Utilty for Handling ADT Objects</p>
CLASS zcl_dutils_adt_obj_util DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
...
CLASS zcl_dutils_adt_obj_util IMPLEMENTATION.
